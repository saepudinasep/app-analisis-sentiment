...
class KNNController extends Controller
{
    ...
    public function index()
    {
        ...
        $filePath = resource_path('json/' . $userName . '/KNN_classification_' . $userName . '.json');
        ...
        return view('knn', ['data' => $jsGridData]);
    }
    ...
    public function visual()
    {
        ...
        $filePath = resource_path('json/' . $namaUser . '/KNN_evaluation_' . $namaUser . '.json'); // Path menuju file JSON di direktori resources

        // Periksa apakah file JSON ada
        if (file_exists($filePath)) {
            // Baca data dari file JSON
            $data = json_decode(file_get_contents($filePath));
            $fileClassification = resource_path('json/' . $namaUser . '/KNN_classification_' . $namaUser . '.json');
