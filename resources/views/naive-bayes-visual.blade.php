...
@section('title', 'Visualisasi Naive Bayes')

@section('content')

    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Confusion Matrix Klasifikasi Naive Bayes</h3>
        </div>
        <div class="card-body">
    ...
    <div class="row">
        <div class="col-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Visualisasi Sentiment Naive Bayes</h3>
                </div>
                <div class="card-body">
        ...
        <script>
            var ctx = document.getElementById('naiveChart').getContext('2d');
            var naiveChart = new Chart(ctx, {
                type: 'pie',
                data: {
        ...
        <div class="col-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Akurasi Sentiment Naive Bayes</h3>
                </div>
                <div class="card-body">
