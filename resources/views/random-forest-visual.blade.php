...
@section('title', 'Visualisasi Random Forest')

@section('content')

    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Confusion Matrix Klasifikasi Random Forest</h3>
        </div>
        <div class="card-body">
    ...
    <div class="row">
        <div class="col-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Visualisasi Sentiment Random Forest</h3>
                </div>
                <div class="card-body">
        ...
        <script>
            var ctx = document.getElementById('randomForestChart').getContext('2d');
            var randomForestChart = new Chart(ctx, {
                type: 'pie',
                data: {
        ...
        <div class="col-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Akurasi Sentiment Random Forest</h3>
                </div>
                <div class="card-body">
