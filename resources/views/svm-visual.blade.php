...
@section('title', 'Visualisasi SVM')

@section('content')

    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Confusion Matrix Klasifikasi SVM</h3>
        </div>
        <div class="card-body">
    ...
    <div class="row">
        <div class="col-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Visualisasi Sentiment SVM</h3>
                </div>
                <div class="card-body">
        ...
        <script>
            var ctx = document.getElementById('svmChart').getContext('2d');
            var svmChart = new Chart(ctx, {
                type: 'pie',
                data: {
        ...
        <div class="col-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Akurasi Sentiment SVM</h3>
                </div>
                <div class="card-body">
