...
@section('title', 'Visualisasi Logistic Regression')

@section('content')

    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Confusion Matrix Klasifikasi Logistic Regression</h3>
        </div>
        <div class="card-body">
    ...
    <div class="row">
        <div class="col-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Visualisasi Sentiment Logistic Regression</h3>
                </div>
                <div class="card-body">
        ...
        <script>
            var ctx = document.getElementById('logisticChart').getContext('2d');
            var logisticChart = new Chart(ctx, {
                type: 'pie',
                data: {
        ...
        <div class="col-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Akurasi Sentiment Logistic Regression</h3>
                </div>
                <div class="card-body">
